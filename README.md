...
```# My Python Practice Project
  ...
  This repository contains various Python practice scripts and Projects, organised for easy learning and reference.├── .github
│   ├── workflows
│   │   ├── python-app.yml
├── .gitignore.py
├── Basics
...
├── Control_Flow
│   ├── .gitkeep
│   ├── Control_FlowREADME.md
│   ├── if_else_quiz.py
│   ├── loops1.py
├── DataStructures
│   ├── .gitkeep
│   ├── DataStructureREADME.md
│   ├── checking_for_existence_in_list.py
│   ├── complete_list.py
│   ├── copying_list.py
│   ├── iterating_list.py
...
├── OtherConcepts
│   ├── OtherConceptsREADME.md
│   ├── arguments_and_comments.py
│   ├── counting_1to10.py
...
│   ├── hello_github.py
│   ├── repeat.py
├── checking _for_existence_in_list.py
├── even_odd_with_f.py
├── explaining_return.py
├── functions
│   ├── FunctionsREADME.md
│   ├── function_start.py
...
│   ├── welcome_function.py
├── guess _number_3attempts.py
├── input_function2.py
├── python _quiz_game.py
├── screenshots
├── src
│   ├── dev_greeting.py
