...
3. Run any Python script: Replace filename.py with the name of the script you want to execute:
...
area_of_rectangle.py: Calculates the area of a rectangle based on user input.
...
basic_quiz_game.py: A simple interactive quiz.
...
age_group.py: Classifies age into groups (child, teen, adult, etc.).
